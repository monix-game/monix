...
// ---------------------------------------------------------------------------
// Sailors (passive fishing crew)
// ---------------------------------------------------------------------------

export const SAILOR_MAX_LEVEL = 30;
export const SAILOR_HIRE_BASE_COST = 1000;
export const SAILOR_HIRE_GROWTH = 1.65;
export const SAILOR_LEVELUP_BASE_COST = 500;
export const SAILOR_LEVELUP_GROWTH = 1.8;
export const SAILOR_RATE_PER_LEVEL_PER_SEC = 2;
export const SAILOR_OFFLINE_CAP_MS = 8 * 60 * 60 * 1000; // 8h max offline accrual
...
export function getSailorRatePerSec(level: number): number {
  return SAILOR_RATE_PER_LEVEL_PER_SEC * clampSailorLevel(level);
}
